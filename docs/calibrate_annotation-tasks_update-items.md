## calibrate annotation-tasks update-items
...
```
  ...
  -h, --help               help for update-items
  -t, --task-uuid string   Annotation task to act on [required]
  -u, --updates string     The new payload for each item you're updating. Entries not in this task, or referencing deleted items, are skipped [required]
