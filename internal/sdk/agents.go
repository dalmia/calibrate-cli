...
// VerifyConnection - Verify agent connection
// Verify an agent's connection and persist the result when successful
func (s *Agents) VerifyConnection(ctx context.Context, request operations.VerifyAgentConnectionAgentsAgentUUIDVerifyConnectionPostRequest, opts ...operations.Option) (*operations.VerifyAgentConnectionAgentsAgentUUIDVerifyConnectionPostResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/agents/{agent_uuid}/verify-connection", request, nil)
	if err != nil {
	...
	res := &operations.VerifyAgentConnectionAgentsAgentUUIDVerifyConnectionPostResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out components.VerifyConnectionResponse
				if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
					return nil, err
				}

				res.VerifyConnectionResponse = &out
			}
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
...
func (s *Agents) Create(ctx context.Context, request operations.CreateAgentEndpointAgentsPostRequest, opts ...operations.Option) (*operations.CreateAgentEndpointAgentsPostResponse, error) {
	...
	res := &operations.CreateAgentEndpointAgentsPostResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out components.PaginatedResponseAgentSummary
				if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
					return nil, err
				}

				res.PaginatedResponseAgentSummary = &out
			}
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
...
func (s *Agents) Get(ctx context.Context, request operations.GetAgentEndpointAgentsAgentUUIDGetRequest, opts ...operations.Option) (*operations.GetAgentEndpointAgentsAgentUUIDGetResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/agents/{agent_uuid}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetAgentEndpointAgentsAgentUUIDGetResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
func (s *Agents) Update(ctx context.Context, request operations.UpdateAgentEndpointAgentsAgentUUIDPutRequest, opts ...operations.Option) (*operations.UpdateAgentEndpointAgentsAgentUUIDPutResponse, error) {
	...
	res := &operations.UpdateAgentEndpointAgentsAgentUUIDPutResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
// ListEvaluators - List agent evaluators
// List evaluators linked to an agent
func (s *Agents) ListEvaluators(ctx context.Context, request operations.ListAgentEvaluatorsAgentsAgentUUIDEvaluatorsGetRequest, opts ...operations.Option) (*operations.ListAgentEvaluatorsAgentsAgentUUIDEvaluatorsGetResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
		operations.SupportedOptionSkipDeserialization,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/agents/{agent_uuid}/evaluators", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.ListAgentEvaluatorsAgentsAgentUUIDEvaluatorsGetResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
// LinkEvaluators - Link evaluators to agent
// Link one or more existing evaluators to an agent, skipping any already linked
func (s *Agents) LinkEvaluators(ctx context.Context, request operations.LinkEvaluatorsToAgentAgentsAgentUUIDEvaluatorsPostRequest, opts ...operations.Option) (*operations.LinkEvaluatorsToAgentAgentsAgentUUIDEvaluatorsPostResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
		operations.SupportedOptionSkipDeserialization,
	...
	res := &operations.LinkEvaluatorsToAgentAgentsAgentUUIDEvaluatorsPostResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
