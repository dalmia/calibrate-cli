#
# calibrate CLI Installation Script for Windows
# This script downloads and installs the latest version of the calibrate CLI
#
# Usage:
#   iwr -useb https://raw.githubusercontent.com/dalmia/calibrate-cli/main/scripts/install.ps1 | iex
#   or
...
function Install-CLI {
    Write-ColorOutput "Installing calibrate CLI..." -Color Green
    ...
    $archiveName = "calibrate_Windows_$arch.zip"
    $downloadUrl = "https://github.com/$Repo/releases/download/$Version/$archiveName"

    Write-ColorOutput "Downloading from: $downloadUrl" -Color Cyan

    # Create temporary directory
    $tempDir = Join-Path $env:TEMP "calibrate-install-$(New-Guid)"
    ...
    try {
        ...
        Write-ColorOutput "calibrate $Version has been installed to $binaryPath" -Color Green
        ...
        Write-ColorOutput "Installation successful! Run 'calibrate --help' to get started." -Color Green
