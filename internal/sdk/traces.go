...
func newTraces(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Traces {
	return &Traces{
		rootSDK:          rootSDK,
...
func (s *Traces) Create(ctx context.Context, request operations.IngestTraceTracesPostRequest, opts ...operations.Option) (*operations.IngestTraceTracesPostResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/traces")
	if err != nil {
	...
	res := &operations.IngestTraceTracesPostResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out components.TraceIngestResponse
				if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
					return nil, err
				}

				res.TraceIngestResponse = &out
			}
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
