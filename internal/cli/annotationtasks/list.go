...
func initListCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		Use:     "list",
		Short:   "List annotation tasks",
		Long:    "List annotation tasks with linked evaluators",
		Example: "  calibrate annotation-tasks list",
		RunE:    runListCmd,
	}
	flagutil.RegisterFlags(cmd, listCmdMeta)
	if err := flagutil.ValidateMeta[operations.ListAnnotationTasksAnnotationTasksGetRequest](listCmdMeta); err != nil {
...
func runListCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.ListAnnotationTasksAnnotationTasksGetRequest](cmd, listCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.AnnotationTasks.List(cmd.Context(), req, sdkOpts...)
	if err != nil {
